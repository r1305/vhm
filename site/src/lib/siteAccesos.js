...
const CATALOG_SEED = [
  ...
  { clave: 'usuarios',    nombre: 'Administradores', descripcion: 'Usuarios del panel admin',      seccion: 'config',    orden: 3 },
  { clave: 'config',      nombre: 'Ajustes',         descripcion: 'Configuración del sitio',       seccion: 'config',    orden: 4 },
  { clave: 'accesos',     nombre: 'Accesos',         descripcion: 'Permisos de vistas por usuario', seccion: 'config',   orden: 5 },
];

const DEFAULTS_ADMIN = ['reclamos', 'testimonios', 'usuarios'];
