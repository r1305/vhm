<template>
  <div>
    ...
    <div class="sub-tabs">
      <button :class="{ active: tabActivo === 'resumen' }" @click="tabActivo = 'resumen'">📊 Resumen</button>
...
<script setup>
import { ref } from 'vue'
import ResumenTab from './videos/ResumenTab.vue'
import VideosTab from './videos/VideosTab.vue'
